...
# 输入栅格数据和掩膜文件
input_raster_folder = r"C:\Users\r\Desktop\classify\qinghai\qinghai"  # 输入栅格数据路径
mask_shapefile = r"C:\Users\r\Desktop\classify\province\qinghai\qinghai.shp"  # 掩膜矢量文件路径

# 输出文件夹路径
output_raster_folder = r"C:\Users\r\Desktop\classify\qinghai\extracted"  # 输出文件夹路径

# 检查输出文件夹是否存在，不存在则创建
if not os.path.exists(output_raster_folder):
    os.makedirs(output_raster_folder)
# 输出文件夹路径
wgs84_raster_folder = r"C:\Users\r\Desktop\classify\qinghai\wsg84"  # 输出文件夹路径
